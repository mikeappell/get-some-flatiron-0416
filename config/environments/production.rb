Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://getsome-lunch.herokuapp.com', 'http://getsome-lunch.herokuapp.com' ]
  ...
  # config.active_job.queue_name_prefix = "get_some_#{Rails.env}"
