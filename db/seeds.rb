...
o_bento = Order.create(organization: org_flatiron , date_ordered: DateTime.now, expiration: (DateTime.now + 1.hours), admin: u_johnny, restaurant: r_bento, description: "Because Japanese food is the bomb diggity", minimum_cost: 30, group: g_flatironNYC, image_url: "bento.png")
...
o_jamaicanstand = Order.create(organization: org_flatiron , date_ordered: DateTime.now, expiration: (DateTime.now + 2.hours), admin: u_george, restaurant: r_jamaicanstand, description: "Who knew they delivered?", minimum_cost: 10, group: g_flatironNYC, image_url: "jamaican.png")
...
o_tgifridays = Order.create(organization: org_flatiron , date_ordered: DateTime.now, expiration: (DateTime.now + 1.5.hours), admin: u_camille, restaurant: r_tgifridays, description: "Everybody join this order. I want Friday!", minimum_cost: 25, group: g_flatironBrooklyn, image_url: "TGI-Fridays.jpg")

####note: order by camille for flatiron school Brooklyn --
r_kfc = Restaurant.create(name: "KFC", url: Faker::Internet.url)
o_kfc = Order.create(organization: org_flatiron , date_ordered: DateTime.now, expiration: (DateTime.now + 2.2.hours), admin: u_camille, restaurant: r_kfc, description: "Chicken. 'Nuff said", minimum_cost: 30, group: g_flatironBrooklyn, image_url: "kfc.jpg")
...
o_bento_chase = Order.create(organization: org_chasebank, date_ordered: DateTime.now, expiration: (DateTime.now + 5.hours), admin: u_bob, restaurant: r_bento_chase, description: "We can make more money by eating from Bento", minimum_cost: 30, group: g_chase115fifth, image_url: "bento-chase.jpg")
...
o_carvels = Order.create(organization: org_flatiron , date_ordered: (DateTime.now - 5.hours), expiration: (DateTime.now - 6.hours), admin: u_johnny, restaurant: r_carvels, description: "For Ivo's birthday party!!!", minimum_cost: 30, group: g_flatironNYC)
